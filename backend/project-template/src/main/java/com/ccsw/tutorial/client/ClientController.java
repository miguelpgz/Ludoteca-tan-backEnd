...
public class ClientController {
	...
	@RequestMapping(path = { "/check-repeated" }, method = RequestMethod.POST)
	public boolean isClientRepeated(@RequestBody ClientDto data) {

		Client result = this.clientService.getClientByName(data.getName());
